...
{
    [Serializable]
    public partial class PmRefHistTable : TableInfo
    {
        public const string C_TableName = "PM_REF_HIST";
        ...
        public const string C_CHANGE_USER_ID = "CHANGE_USER_ID";
        public const string C_CHANGE_COMMENT = "CHANGE_COMMENT";
        //public const string C_CAL_INTERVAL = "CAL_INTERVAL";
        public const string C_CHANGE_FROM = "CHANGE_FROM";
        public const string C_CHANGE_TO = "CHANGE_TO";
        public const string C_CHANGE_NO = "CHANGE_NO";
        ...
        public PmRefHistTable()
        {
            _tableName = "PM_REF_HIST";
        }

        protected static PmRefHistTable _current;
        public static PmRefHistTable Current
        {
            get
            {
                if (_current == null)
        ...
        {
            _current = new PmRefHistTable();

            _current.Add(C_PM_ID, new ColumnInfo(C_PM_ID, "PmId", true, typeof(decimal)));
            ...
            _current.Add(C_OBJECT_ID, new ColumnInfo(C_OBJECT_ID, "ObjectId", false, typeof(decimal)));
            _current.Add(C_ARTGRP_ID, new ColumnInfo(C_ARTGRP_ID, "ArtgrpId", false, typeof(decimal)));
            _current.Add(C_PM_STATUS, new ColumnInfo(C_PM_STATUS, "PmStatus", false, typeof(int)));
            ...
            _current.Add(C_CHANGE_USER_ID, new ColumnInfo(C_CHANGE_USER_ID, "ChangeUserId", false, typeof(decimal)));
            ...
            _current.Add(C_CHANGE_FROM, new ColumnInfo(C_CHANGE_FROM, "ChangeFrom", false, typeof(DateTime)));
            _current.Add(C_CHANGE_TO, new ColumnInfo(C_CHANGE_TO, "ChangeTo", false, typeof(DateTime)));
            _current.Add(C_CHANGE_NO, new ColumnInfo(C_CHANGE_NO, "ChangeNo", true, typeof(long)));
        ...
        public ColumnInfo CHANGE_USER_ID
        {
            get { return this[C_CHANGE_USER_ID]; }
        }
        ...
        public ColumnInfo CHANGE_FROM
        {
            get { return this[C_CHANGE_FROM]; }
        }

        public ColumnInfo CHANGE_TO
        {
            get { return this[C_CHANGE_TO]; }
        }

        public ColumnInfo CHANGE_NO
        {
            get { return this[C_CHANGE_NO]; }
        }
